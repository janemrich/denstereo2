...
class GDRN(nn.Module):
    def __init__(self, cfg, backbone, geo_head_net, selfocc_head_net, neck=None, pnp_net=None, disp_net=None):
        super().__init__()
        assert cfg.MODEL.POSE_NET.NAME == "GDRN_stereo_disp", cfg.MODEL.POSE_NET.NAME
    ...
    def forward(
        ...
        outpath = "/home/yan/gdnr_selfocc/core/gdrn_stereo_modeling/output/gdrn_selfocc/ycbv/x.pkl"
        outpath2 = "/home/yan/gdnr_selfocc/core/gdrn_stereo_modeling/output/gdrn_selfocc/ycbv/coor.pkl"
        outpath3 = "/home/yan/gdnr_selfocc/core/gdrn_stereo_modeling/output/gdrn_selfocc/ycbv/occ.pkl"
        outpath4 = "/home/yan/gdnr_selfocc/core/gdrn_stereo_modeling/output/gdrn_selfocc/ycbv/gt_occ.pkl"
        outpath5 = "/home/yan/gdnr_selfocc/core/gdrn_stereo_modeling/output/gdrn_selfocc/ycbv/gt_coor.pkl"
        outpath6 = "/home/yan/gdnr_selfocc/core/gdrn_stereo_modeling/output/gdrn_selfocc/ycbv/gt_mask.pkl"
        outpath7 = "/home/yan/gdnr_selfocc/core/gdrn_stereo_modeling/output/gdrn_selfocc/ycbv/gt_occmask.pkl"
        outpath8 = "/home/yan/gdnr_selfocc/core/gdrn_stereo_modeling/output/gdrn_selfocc/ycbv/pred_mask.pkl"
    ...
    def gdrn_loss(
        ...
        if gt_mask_erode is None:
            ...
            flat_gt_mask_erode = flat_gt_mask_visib
        gt_masks = {
            "trunc": flat_gt_mask_trunc,
            "visib": flat_gt_mask_visib,
        ...
        if not disp_net_cfg.FREEZE and loss_cfg.DISP_LW > 0.0:
            loss_dict["loss_disp"] = msn_loss(out_disp, gt_disp[:, 0], gt_mask_visib[:, 0])
...
def build_model_optimizer(cfg, is_test=False):
    ...
    # build model
    model = GDRN(cfg, backbone, neck=neck, geo_head_net=geo_head, selfocc_head_net=selfocc_head, pnp_net=pnp_net, disp_net=disp_net)
    if net_cfg.USE_MTL:
        params_lr_list.append(
            {
                "params": filter(
