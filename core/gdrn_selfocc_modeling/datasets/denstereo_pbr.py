...
SPLITS_DENSTEREO_PBR = dict(
    denstereo_train_pbr =dict(
        ...
        xyz_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/train_pbr_left/xyz_crop"),
        xyz_root_right=osp.join(DATASETS_ROOT, "BOP_DATASETS/train_pbr_right/xyz_crop"),
        occ_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/train_pbr_left/Q0"),
        occ_root_right=osp.join(DATASETS_ROOT, "BOP_DATASETS/train_pbr_right/Q0"),
    ...
    denstereo_train_pbr_right =dict(
        ...
        models_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/denstereo/models"),
        xyz_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/train_pbr_right/xyz_crop"),
        occ_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/train_pbr_right/Q0"),
        scale_to_meter=0.001,
        with_masks=True,  # (load masks but may not use it)
        with_depth=True,  # (load depth path here, but may not use it)
        height=480,
